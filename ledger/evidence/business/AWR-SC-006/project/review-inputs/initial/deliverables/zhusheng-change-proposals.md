...
| --- | --- | --- | --- | --- |
| CR-01 资料归档 | `01M21X4H7GSP7DY19MTHYDBXST` | 资料归档按内容类型分目录；三个目录的具体名称或位置及资料类型对应关系须经资料管理员确认后才可应用。 | 资料管理员 | `ready`，未批准、未应用 |
...
2. 目录具体值、角色分配和遗留问题明细仍属未知；确认者必须补充事实与来源，不能只确认建议措辞。
