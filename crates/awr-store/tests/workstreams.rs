...
impl LegacyFixture {
    fn new() -> Self {
        ...
        fixture.sql("PRAGMA foreign_keys=OFF; BEGIN IMMEDIATE; DROP TABLE workstream_ownership; DROP TABLE workstreams; DROP TABLE workstream_catalogs; DELETE FROM schema_migrations WHERE version=5; PRAGMA user_version=4; COMMIT;");
        fixture
    }
