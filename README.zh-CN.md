...
可选的 [Inspector 查看界面](tools/inspector/README.md)需从这一版本的源码启动，npm/PyPI 安装包不包含它。
...
回退需要恢复匹配的升级前快照。详见[升级与回退指南](docs/release/DISTRIBUTIONS.md#matched-upgrade-and-rollback-checklist)。
